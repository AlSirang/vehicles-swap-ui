      ...
      <Form onSubmit={onRegister}>
        ...
        <div className="row">
          <Form.Group className="mb-3 col-md-6" controlId="value">
            ...
            <Form.Control type="text" placeholder="Estimated Value" required />
          </Form.Group>
        ...
        {/********************************************************************/}
        <div className="row">
          <Form.Group className="mb-3 col-md-6" controlId="wheelConfiguration">
        ...
        <div className="row">
          <Form.Group className="mb-3 col-md-6" controlId="seatingCapacity">
            ...
            <Form.Control type="text" placeholder="Seating capacity" required />
          </Form.Group>
